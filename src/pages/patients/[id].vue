...
import { appearances, behaviors, chronic_disorders, cognitive, diagnoses, family_hxs, insights, managements, moods, perceptions, present_illness, speeches, substances, suicides, thought_contents, thought_forms } from '../../config/suggestions'
